...
#. Grading rubric:
   ...
   - \+ 10% Create a new `ROS node <https://github.com/UCR-Robotics/ee106/blob/Spring2024/scripts/rangescheck_jackal.py>`_ that will subscribe to the robot's LiDAR ROS topic. The ROS message type of the LiDAR ROS Topic is the `sensor_msgs/LaserScan <http://docs.ros.org/en/noetic/api/sensor_msgs/html/msg/LaserScan.html>`_.
